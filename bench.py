...
from common import (CACHE_DIR, LOOP_PAD_MAX, PAD_MAX, RESULTS_DIR,
                    cache_path, cache_vectors, load_cached_vectors, load_model,
                    log, model_slug, resolve_model, task_dirs)
...
def to_vecs_multi(model, tok, texts, layers, batch=24, label=""):
    ...
    #     path" caveat in paper/implication-early-layer.md §3 made concrete.
