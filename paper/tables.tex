...
loop). Table~\ref{tab:placement} uses the same 10k/4k protocol; displayed
RuleTaker finals match.
...
(mean--vote can differ by ${\sim}$1pt). RuleTaker is the same 10k/4k
protocol as Table~\ref{tab:main}. \emph{Layers} = stack depth
...
11/18 cells raw (10/18 after Benjamini--Hochberg FDR at $q{<}0.05$) and never
lose significantly.}
\label{tab:placement}
\small
\setlength{\tabcolsep}{3.5pt}%
...
\multirow{6}{*}{RuleTaker}
  & Qwen3-0.6B & 28 & L18 & 64\% & \sd{L13 (48\%)} &0.720 & 0.684 & \sd{+0.036}\pstarstarstar & $1.8\mathrm{e}{-07}$ \\
  & Qwen3-4B   & 36 & L24 & 67\% & L24 (69\%) &0.796 & 0.782 & \sd{+0.014}\pstar & 0.027 \\
  & Qwen3-8B   & 36 & L24 & 67\% & L24 (69\%) &0.797 & 0.782 & \sd{+0.015}\pstarstar & $5.0\mathrm{e}{-03}$ \\
  & Mistral-7B & 32 & L16 & 50\% & \sd{L11 (35\%)} &0.732 & 0.682 & \sd{+0.050}\pstarstarstar & $2.6\mathrm{e}{-09}$ \\
  & Granite-3.1-8B & 40 & L20 & 51\% & \sd{L17 (44\%)} &0.845 & 0.823 & \sd{+0.022}\pstarstarstar & $1.0\mathrm{e}{-05}$ \\
  & DeepSeek-V4-Flash & 43 & L29 & 67\% & \sd{L22 (52\%)} &0.807 & 0.797 & \sd{+0.010}\pstar & 0.020 \\
\midrule
