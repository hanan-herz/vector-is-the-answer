...
generation. On BoolQ (full validation), RuleTaker (10k/4k), and
...
verbal channel is weakest (RuleTaker $+11.9$pt on Granite-8B, $+9.0$pt at
...
deduction (RuleTaker at DeepSeek-V4), and Mistral-7B on BoolQ. The map
