...
Sweeping the classifier's readout across the model shows that the answer is
often assembled by mid-depth: the best mid-layer readout significantly beats
the final-layer readout in 6 of 18 cells after correction and never loses
significantly. The results suggest that, for this defined class of
classification tasks, the model's internal vector often already contains the
answer, while the autoregressive loop remains useful in several identifiable
regimes.
\end{abstract}
