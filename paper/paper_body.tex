...
mid-layer readout beats the final layer in 6 of 18 cells after correction and
...
\item \textbf{On ARC the loop wins when the probe is weak.} The
  ...
  accuracy 0.708. Two further exceptions sit outside ARC: DeepSeek-V4 on
  RuleTaker and Mistral-7B on BoolQ (\S\ref{sec:boundary}).
\item \textbf{Answer-relevant information is already present mid-depth.} The
  best mid-layer tap beats the final layer at 9/18 cells (6/18 after
...
require the loop; a frozen continuous-latent loop drifts
